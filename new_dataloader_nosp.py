...
#path_to_2018compare = "./new_cluster_2018/5min_moving/" 
            ...
            for pair in range(len(table)):  
                if Use_avg :      
                    ...
                    if normalize_spread == True :
                        ...
                        spread[:] = (spread[:] - table.mu[pair])/table.stdev[pair]
                        new_spread = np.zeros((4,512))
                        #new_spread[0,106:406] = spread    
                        mindata1 = halfmin[str(table.stock1[pair])][32:332].values
                        mindata2 = halfmin[str(table.stock2[pair])][32:332].values
                        mindata3 = (halfmin[str(table.stock1[pair])][33:333].values-halfmin[str(table.stock1[pair])][32:332].values)/halfmin[str(table.stock1[pair])][32:332].values
                        mindata4 = (halfmin[str(table.stock2[pair])][33:333].values-halfmin[str(table.stock2[pair])][32:332].values)/halfmin[str(table.stock2[pair])][32:332].values

                        mindata1 = preprocessing.scale(mindata1)
                        mindata2 = preprocessing.scale(mindata2)
                        mindata3 = preprocessing.scale(mindata3)
                        mindata4 = preprocessing.scale(mindata4)
                        new_spread[0,106:406] = mindata1
                        new_spread[1,106:406] = mindata2
                        new_spread[2,106:406] = mindata3
                        new_spread[3,106:406] = mindata4
                if date[0:6] == "201610" or date[0:6] == "201611" or date[0:6] =="201612" : #validation data
                            number = gt[pair][0]
